...
class Model:
    ...
    def load(self, restore_iter):
        self.encoder.load_state_dict(torch.load(
            "/home/minhdoan/Documents/projects/jupyter-notebook/asilla/mct-project/GaitSet-TL/checkpoint/GaitSet/GaitSet_CASIA-B_73_False_256_0.2_128_full_30-80000-encoder.ptm"))
        self.optimizer.load_state_dict(torch.load(
            "/home/minhdoan/Documents/projects/jupyter-notebook/asilla/mct-project/GaitSet-TL/checkpoint/GaitSet/GaitSet_CASIA-B_73_False_256_0.2_128_full_30-80000-optimizer.ptm"))

        """self.encoder.load_state_dict(torch.load(osp.join(
            'checkpoint', self.model_name,
            '{}-{:0>5}-encoder.ptm'.format(self.save_name, restore_iter))))
        self.optimizer.load_state_dict(torch.load(osp.join(
            'ccheckpoint', self.model_name,
